...
import botenanna.overlayWindow.MeasurementDisplay;
...
public class BotenAnna extends Application {
    ...
    private MeasurementDisplay carMeasurementDisplay;
            ...
            public void handle(long now) {
                if (now - lastUpdate.get() > 0) {
                    ...
                    if (bot != null) {
                        ...
                        carMeasurementDisplay.update(bot.getLastInputReceived());
                    }
                    lastUpdate.set(now);
                }
            }
