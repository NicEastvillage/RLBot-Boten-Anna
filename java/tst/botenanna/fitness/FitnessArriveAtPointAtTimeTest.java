...
public class FitnessArriveAtPointAtTimeTest {
    ...
    public void calculateFitnessValue01(){
        ...
        FitnessArriveAtPointAtTime fitness = new FitnessArriveAtPointAtTime(new Path(point), arrivalTime, 0.2,0.2);

        Vector3 myVelocity = new Vector3(10,0,0);
        Vector3 myPosition = new Vector3(0,0,0);

        double fitnessValue = fitness.calculateFitnessValue(myPosition, myVelocity,5);
    ...
    public void calculateFitnessValue02(){
        ...
        FitnessArriveAtPointAtTime fitness = new FitnessArriveAtPointAtTime(new Path(point), arrival, 0.2,0.2);

        Vector3 myVelocity = new Vector3(100,0,0);
        Vector3 myPosition = new Vector3(100,100,0);

        double fitnessValue = fitness.calculateFitnessValue(myPosition, myVelocity, timeSpent);
    ...
    public void calculateFitnessValueComparison01(){
        ...
        FitnessArriveAtPointAtTime fitness1 = new FitnessArriveAtPointAtTime(new Path(point1), arrival1, 0.2,0.2);

        Vector3 myVelocity1 = new Vector3(-300,-300,0);
        Vector3 myPosition1 = new Vector3(200,0,0);

        double fitnessValue1 = fitness1.calculateFitnessValue(myPosition1, myVelocity1, timeSpent1);
        ...
        FitnessArriveAtPointAtTime fitness2 = new FitnessArriveAtPointAtTime(new Path(point2), arrival2, 0.2,0.2);

        Vector3 myVelocity2 = new Vector3(-300,-300,0);
        Vector3 myPosition2 = new Vector3(200,0,0);

        double fitnessValue2 = fitness2.calculateFitnessValue(myPosition2, myVelocity2, timeSpent2);
