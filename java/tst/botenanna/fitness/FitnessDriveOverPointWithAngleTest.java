...
public class FitnessDriveOverPointWithAngleTest {
    ...
    public void calculateFitnessValue01(){ //stopOnPoint = true
        ...
        double fitnessValue = fitness.calculateFitnessValue(destinationPoint, nextPoint, myPos, myDirection,timeSpent, velocity);
    ...
    public void calculateFitnessValueComparison01(){
        ...
        double fitnessValue1 = fitness1.calculateFitnessValue(destinationPoint1, nextPoint1, myPos1, myDirection1, timeSpent1, myCarVelocity1);
        ...
        double fitnessValue2 = fitness2.calculateFitnessValue(destinationPoint2, nextPoint2, myPos2, myDirection2, timeSpent2, myCarVelocity2);
